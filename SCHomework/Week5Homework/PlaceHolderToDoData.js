...
// userThreeTasks = data.filter(task => task.userId == 3);

// class userIncompleteTasks {
//     constructor(totalTasks, totalIncomplete, incompleteTasks) {
//         task.userThreeTasks = totalTasks;
//         task.userNineIncompleteTasksAmount = totalIncomplete;
//         task.userIncompleteTasks = incompleteTasks;
